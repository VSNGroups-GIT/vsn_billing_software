...
CREATE TABLE IF NOT EXISTS public.payments (
  ...
  mediator_deduction_type TEXT CHECK (mediator_deduction_type IN ('percentage', 'amount')),
  mediator_percentage NUMERIC(10, 4),
  mediator_amount NUMERIC(10, 2) NOT NULL DEFAULT 0,
